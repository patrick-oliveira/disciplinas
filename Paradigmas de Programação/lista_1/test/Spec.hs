...
ex10Test = testGroup "ex10"
            [
              ...
              testCase "test5" (assertEqual "Test 5" "Você fará 22 anos em 2022!" (aniversario 2000)),
              testCase "test6" (assertEqual "Test 6" "Você fará 42 anos em 2022!" (aniversario 1980))
            ]
