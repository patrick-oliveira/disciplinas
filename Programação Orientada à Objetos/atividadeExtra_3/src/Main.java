...
public class Main {
	...
	public static void main(String[] args) {
		...
		(funcionarios[0]).setHorasExtras(20);
		funcionarios[1] = new Horista("Pessoa 2", "456", "Setor2");
		(funcionarios[1]).setTotalHoras(45);
		(funcionarios[1]).setValorHora(20);
		funcionarios[2] = new Horista("Pessoa 3", "789", "Setor3");
		(funcionarios[2]).setTotalHoras(34);
		funcionarios[3] = new Efetivo("Pessoa 4", "101112", "Setor4");
		(funcionarios[3]).setSalario(2700);
		funcionarios[4] = new Efetivo("Pessoa 5", "131415", "Setor5");
		(funcionarios[4]).setSalario(1300);
		(funcionarios[4]).setHorasExtras(15);
;
